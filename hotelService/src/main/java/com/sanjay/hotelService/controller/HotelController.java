package com.sanjay.hotelService.controller;
...
public class HotelController {
	...
	@GetMapping("/{hotelId}")
	public ResponseEntity<Hotel>getByUserId(@PathVariable String hotelId){
		return ResponseEntity.ok(hotelServices.get(hotelId));
	}
}
